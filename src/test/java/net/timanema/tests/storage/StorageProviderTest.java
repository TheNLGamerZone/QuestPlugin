...
package net.timanema.tests.storage;

import net.timanema.questplugin.storage.StorageProvider;
import net.timanema.questplugin.storage.workers.FileStorage;
import net.timanema.questplugin.storage.workers.MongoStorage;
import net.timanema.questplugin.storage.workers.SQLStorage;
